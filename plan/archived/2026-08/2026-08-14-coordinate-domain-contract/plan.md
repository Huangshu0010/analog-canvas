...
Commit status: initial implementation committed as `2cc807c`; the CI follow-up
landed on `origin/main` as `8fa7cdf` after the annotation-path repair and
release-checksum refresh.
