...
| --- | ---: | --- |
| `completed` + `none` | 9 | `2026-08-18-schematic-hierarchy-v12`, `2026-08-18-plan-docs-retention`, `2026-08-18-hierarchy-authoring-visual-h1` through `2026-08-18-hierarchy-authoring-visual-h5`, `2026-08-18-hierarchy-domain-refactor`, and `2026-08-18-merge-hierarchy-main` await their normal archive passes. |
