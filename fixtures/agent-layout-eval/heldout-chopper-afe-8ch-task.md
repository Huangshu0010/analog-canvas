...
visually unambiguous. Make differential channel boundaries, shared control,
bias, power, and signal flow readable without relying on explanatory prose.
