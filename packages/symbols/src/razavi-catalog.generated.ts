...
export const razaviSymbolCatalogEntries: readonly RazaviSymbolCatalogEntry[] = [
  ...
  },
  {
    ...
    assetHash:
      "5ad8dc60b23394081e7430d6d6cda1b86558a2384b8630ff51bdff3893b1586e",
    generation: {
      kind: "vss-master-ir",
      evidencePath:
        "fixtures/symbols/vss-ir/razavi-rv6-core-analog-master-ir.json",
  ...
  },
  {
    ...
    assetHash:
      "3a919dd8ef45e6ada7b6df5566eed0b11bd46d61d5d83a354603d7072f46e19c",
    generation: {
      kind: "vss-master-ir",
      evidencePath:
        "fixtures/symbols/vss-ir/razavi-rv6-core-analog-master-ir.json",
  ...
  },
  {
    ...
    assetHash:
      "89999915795be607197969dc8b466f11df6049504401e9b08dc4adca03d28ec3",
  },
  {
    symbolId: "nmos3",
    ...
    assetHash:
      "7dd90e56a29e7ae92a2bc2918ee547d56fdf9e82c09ff229160e7fb9e3512258",
  },
  {
    symbolId: "npn",
  ...
  },
  {
    ...
    assetHash:
      "6845547d607cd3b8c188997ac44d310197a3ec5de186c81be2b57c036fe1d068",
  },
  {
    symbolId: "pmos3",
    ...
    assetHash:
      "4b3401450e1265ba7dcf4ca0f068193ed675cb4bba35065d02e12f7a08b8933a",
  },
  {
    symbolId: "pnp",
  ...
  },
  {
    ...
    assetHash:
      "c24b68291bef8b52aea0cc5f52908f3a0409ff5a4c1f67a85d774de7b9a00340",
    generation: {
      kind: "vss-master-ir",
      evidencePath:
        "fixtures/symbols/vss-ir/razavi-rv6-core-analog-master-ir.json",
