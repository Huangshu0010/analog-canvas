...
export const razaviCatalogSymbols: readonly SymbolDefinition[] = [
  ...
  },
  {
    ...
    primitives: [
      ...
      {
        kind: "path",
        data: "M -26.7979 -21.427487 L -26.7979 21.429187 L 23.2021 0.002116 Z",
        style: {
          strokeRole: "emphasis",
          lineCap: "butt",
          lineJoin: "miter",
      ...
      },
      {
        kind: "line",
        from: {
          x: -13.404537752215727,
          y: 8.037135921633837,
        },
        to: {
          x: -13.404537752215727,
          y: 13.394232247898557,
        },
        style: {
          strokeRole: "normal",
          lineCap: "butt",
