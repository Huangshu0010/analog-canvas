...
symbol presentation intent. A canonical v14 file can be opened, saved,
reopened, and saved again without byte drift.
Schema v13 is accepted through one direct upgrade to v14. It does not remain a
v13 Project in the editor: absent Cell symbol presentation and pin-label
placement select deterministic
automatic geometry, and the next save writes v14. The original file is never
overwritten silently. Schema v12 and older, and versions newer than v14, are
