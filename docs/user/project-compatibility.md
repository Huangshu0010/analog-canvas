...
The released Project schema version is `5`. A canonical v5 file can be opened,
saved, reopened, and saved again without byte drift. Version 1 through 4 files
are accepted through the registered migration chain; every new save writes v5.
...
The canonical `fixtures/projects/minimal/project.icproj.json` file is a v5
