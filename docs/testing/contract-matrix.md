...
| Validation policy and change-impact selection                    | `scripts/lib/{validation-gates,ci-validation-plan,test-impact}.test.mjs`                                           | focused required browser checks with conservative full fallback |
