...
| Validation policy and change-impact selection                    | `scripts/lib/{validation-gates,test-impact}.test.mjs`                                                              | advisory GitHub Actions gate-plan summary plus unchanged required checks |
