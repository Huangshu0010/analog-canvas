...
2. [`../adr/0022-current-protocol-baseline.md`](../adr/0022-current-protocol-baseline.md),
   ...
   and [`../adr/0034-top-cell-formal-port-and-free-port-export.md`](../adr/0034-top-cell-formal-port-and-free-port-export.md)
   ...
   and RichText display, top-Cell formal interfaces, Free Net Port export, and
   Agent credential contract; identify superseded
