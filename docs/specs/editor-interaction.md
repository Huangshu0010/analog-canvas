...
and terminates its Agent session. A complete schema-25 Project may be upgraded
at the read boundary and then enters the editor only as schema-26; migrated
