...
and terminates its Agent session. A complete schema-13 Project may be upgraded
at the read boundary and then enters the editor only as schema-14; migrated
