...
| Agent takeover: authority migration, lifecycle, files, and collaboration  | implementation in progress; M0--M2 authority migrations complete, M3 next | [four-operation completion plan](agent-takeover-v2-completion-plan.md) and [ADR 0019](../adr/0019-four-operation-agent-golden-contract.md) |
