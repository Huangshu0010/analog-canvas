...
|     5 | [`Symbols and Visual Quality`](phase-5-symbols-and-visual-quality.md)                             | superseded | Archived VSS-era record; current visual work uses the Razavi extension spec |
